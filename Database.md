...
- 다중 데이타베이스 트랜잭션 회복
	...
	- 원자성을 확보하기 위해 전역 회복 관리자 OR 조정자 레벨과 지역 회복 관리자 OR 참여자 레벨에서 수행하는 회복 기법에 있어야 한다
	...
	- 단계 1이 완료되기 전에 일어나는 장애에 대해서는 트랜잭션 취소 하고 단계 2 수행 중 일어나는 장애는 트랜잭션을 회복하고 완료할 수 있다.
